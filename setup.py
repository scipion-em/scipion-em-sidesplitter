...
from sidesplitter import __version__
...
setup(
    ...
    name='scipion-em-sidesplitter',  # Required
    ...
    description='Plugin to use SIDESPLITTER program within the Scipion framework',  # Required
    ...
    url='https://github.com/scipion-em/scipion-em-sidesplitter',  # Optional
    ...
    package_data={  # Optional
       'sidesplitter': ['sidesplitter_logo.png', 'protocols.conf'],
    },
    ...
    entry_points={
        'pyworkflow.plugin': 'sidesplitter = sidesplitter'
    }
)
